...
<div>
  <h2 id="header_perfil" class="ui dividing header" style="">Meu Perfil</h2>
    <div class="image content" id="img_perfil" style="">
        <div id="div_img_home" class="ui massive image" style="">
      ...
      <input type="hidden" name="usuarios[id_usuario]" value="<?php echo $usuario_logado['id_usuario'];?>">
        ...
        <div class="two fields">
          ...
          <div class="actions" style="">
              <div style="" id="btn_alterar" class="ui right orange labeled icon submit button">
                Salvar Alterações
                <i class="edit icon"></i>
              </div>              <div style="" id="btn_alterar" class="ui right blue labeled icon button">
                Recuperar Senha
                <i class="lock icon"></i>
              </div>
          </div> 
